<template>
  <header
    class="flex items-center justify-between px-6 py-2 bg-white border-b-1 border-indigo-600"
  >
    ...
    <div class="flex items-center">
      <div class="relative">
        ...
        >
          <div
            v-show="dropdownOpen"
            class="absolute right-0 z-20 w-48 py-1 mt-2 bg-white rounded-lg shadow-xl px-1"
          >
            <!-- <a
              href="#"
